    ...
    <div className="p-5 flex flex-col gap-5">
      ...
      <table className="w-full">
        ...
        <tbody>
          <tr>
            <td
              className={`py-[18px] text-center border text-black-opacity-80 text-sm`}
            >
              {data?.data?.paperSize?.height} x {data?.data?.paperSize?.width}{" "}
              {data?.data?.unit}
            </td>
            <td
              className={`py-[18px] text-center border text-black-opacity-80 text-sm`}
            ...
            <td
              className={`py-[18px] font-semibold text-center border main-text-color text-sm`}
            >
