...
const OrderDetailsTable = ({ data }: any) => {
  ...
  return (
    <table className="w-full">
      ...
      {data?.data?.orderItems?.map((items: any, index: number) => {
        return (
          <tbody
            key={index.toString()}
            ...
            <tr>
              ...
              <td className="border px-3 py-2 md:py-4 ">
                <div className="flex gap-3 text-start ">
                  <div className="w-[28px] h-[28px] md:w-[40px] md:h-[40px] shrink-0 relative mt-1.5">
                    <Image
              ...
              <td className="border md:px-5 py-2 md:py-4 main-text-color">
                {items?.orderQuantity}
              </td>
              <td className="border px-2 py-2 md:py-4 main-text-color text-center">
                {handleProduct(
                  items?.orderQuantity,
