...
interface printingStatusUpdateModalProps {
  handleModal: (value: boolean) => void;
  data: any;
}

const PrintingStatusUpdateModal = ({
  handleModal,
  data,
}: printingStatusUpdateModalProps) => {
  ...
  return (
    <div>
      <CustomGlobalModal isVisible={handleModal} setOpenModal={handleModal}>
...
export default PrintingStatusUpdateModal;
